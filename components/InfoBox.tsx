...
const InfoBox = ({ hoveredItem, selectedItem, setSelectedItem, modal, setShowModal }: InfoBoxProps) => {
  ...
  return (
    <section className={`relative card w-full  p-6 flex-col gap-6 overflow-y-auto scrollbar ${modal ? "mx-auto flex h-full max-w-md" : "m-0 hidden md:flex max-w-sm lg:max-w-md"}`}>
